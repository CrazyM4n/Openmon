...
floors["openMonCenterFloor"] = pygame.transform.scale2x(pygame.image.load("img/maps/openMonCenterFloor.png")) #credit to http://www.vg-resource.com/showthread.php?tid=8889

tiles = dict()
tiles["tallGrass"] = pygame.transform.scale2x(pygame.image.load("img/maps/tallgrass.png"))
tiles["openMonCenterWall"] = pygame.transform.scale2x(pygame.image.load("img/maps/openMonCenterWall.png"))
